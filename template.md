...
- มี Mini Test หลังแต่ละช่วง
- มี Mock Exam รวมท้ายบท
- มี Answer Key ที่อธิบายวิธีคิดก่อนลงคำตอบ
...
- กล่องข้อมูลต้องมีหน้าที่ชัดเจน เช่น สูตร, guardrail, exam watch, mini test, answer
...
3. สารบัญ sticky
4. Segment 1 พร้อม Mini Test 1
5. Segment 2 พร้อม Mini Test 2
6. Segment 3 พร้อม Mini Test 3
7. Segment 4 พร้อม Mini Test 4
8. Mock Exam รวมท้ายบท
9. Answer Key
10. Footer note
...
หลังแต่ละ segment ต้องมี Mini Test หนึ่งชุด
...
Mock Exam ท้ายบทต้องรวมหลาย segment เข้าด้วยกัน
...
Answer Key ต้องอยู่ท้ายหน้าและใช้ `answer-box`
...
- ทุก segment มี Mini Test
- Mock Exam รวมหลายเรื่อง ไม่ใช่โจทย์สั้นซ้ำ Mini Test
- Answer Key เฉลยครบทุก Mini Test และ Mock Exam
...
จัดเป็น hero, quick frame, sticky toc, segment, mini test, mock exam และ answer key
...
-> add mini test after each segment
-> create integrated mock exam
-> write answer key with calculations before journal entries
