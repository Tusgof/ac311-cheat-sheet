...
### ความไม่สมมาตรที่ต้องเข้าใจ

- ฝั่งกำไรจากการตีราคาเพิ่มขึ้น มาตรฐานมองว่าเป็น `unrealized gain` จึงพักไว้ใน `OCI -> Revaluation surplus`
- ฝั่งขาดทุนจากการตีราคาลดลง มาตรฐานใช้แนวคิด `conservatism` จึงให้ลง `profit or loss` ทันที
- ดังนั้นฝั่งกำไรมีบัญชีสะสมของตัวเองคือ `revaluation surplus`
- แต่ฝั่งขาดทุนไม่มีบัญชีพักลักษณะเดียวกัน ผลขาดทุนจะวิ่งผ่าน P/L และไปลด `retained earnings` ทันที
...
- อย่าคิดว่าฝั่งกำไรกับฝั่งขาดทุนสมมาตรกันทุกอย่าง เพราะมาตรฐานจงใจให้ `surplus` มีบัญชีพัก แต่ `loss` ไม่มี
